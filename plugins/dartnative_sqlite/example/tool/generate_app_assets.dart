...
// The --target flag sets the app directory to write assets into (default: this example app).
...
void main(List<String> args) async {
  // Resolve the app directory from the script's own location.
  final appDir = File(Platform.script.toFilePath()).parent.parent;

  // --target lets callers write assets into a different consumer app directory.
  // Defaults to this app itself.
  final targetArg = _arg(args, 'target');
  final targetDir = targetArg != null ? Directory(targetArg) : appDir;
