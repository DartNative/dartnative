...
/// and auth errors are displayed inline. See README.md for the setup matrix.
///
library;
...
// ── Palette ───────────────────────────────────────────────────────────────────
//
// Dark colours used by this single-screen example.

const _kHomeBg = Color(0xFF000000);
const _kBarBg = Color(0xFF1C1C1E);
const _kRowBg = Color(0xFF1C1C1E);
const _kChipBg = Color(0xFF3A3A3C);
const _kTextPrimary = Color(0xFFFFFFFF);
const _kTextSecondary = Color(0xFF8E8E93);
const _kTextTertiary = Color(0xFF636366);

class SocialSignInDemoApp extends StatelessWidget {
  const SocialSignInDemoApp({super.key});

  @override
  Widget build(BuildContext context) {
    return App(
      title: 'dartnative_social_sign_in',
      theme: ThemeData.dark(),
      home: const SocialSignInDemo(),
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (rows.isNotEmpty) ...[
            const SizedBox(height: 10),
            const Divider(color: _kChipBg, height: 1),
            const SizedBox(height: 10),
            ...rows.entries.map(
              (e) => Padding(
