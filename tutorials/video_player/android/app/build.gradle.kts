...
android {
    namespace = "com.dartnative.tutorials.video_player"
    ...
    defaultConfig {
        ...
        applicationId = "com.dartnative.tutorials.video_player"
        // You can update the following values to match your application needs.
        // dartnative_video_player (ExoPlayer/Media3) needs API 26+.
        minSdk = 26
