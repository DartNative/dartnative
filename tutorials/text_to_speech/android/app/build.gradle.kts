...
android {
    namespace = "com.dartnative.tutorials.text_to_speech"
    ...
    defaultConfig {
        ...
        applicationId = "com.dartnative.tutorials.text_to_speech"
        // You can update the following values to match your application needs.
        // dartnative_path_provider (model download cache) needs API 26+.
        minSdk = 26
